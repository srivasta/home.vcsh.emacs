...
;; '(minibuffer-prompt ((t (:foreground "cyan"))))
 ...
 '(mouse ((t (:foregound "white" :background "OrangeRed"))))
 ...
 '(develock-bad-manner ((t (:background "Yellow" :foreground "Black"))) t)
 '(develock-lonely-parentheses ((t (:background "PaleTurquoise" :foreground "Blue"))) t)
 '(develock-long-line-1 ((t (:foreground "Orange"))) t)
 '(develock-long-line-2 ((t (:background "#1a1a42"))) t)
 '(develock-reachable-mail-address ((t (:background "LemonChiffon" :foreground "DarkGreen"))) t)
 '(develock-upper-case-attribute ((t (:background "Wheat" :foreground "Black"))) t)
 '(develock-upper-case-tag ((t (:background "PowderBlue" :foreground "Black"))) t)
 ...
 '(dired-face-marked ((t (:background "PaleVioletRed"))) t)
 '(dired-face-permissions ((t (:background "grey75" :foreground "black"))) t)
 '(dired-face-setuid ((t (:foreground "Red"))) t)
 '(dired-face-socket ((t (:foreground "magenta"))) t)
 '(dired-face-symlink ((t (:foreground "cyan"))) t)

 '(display-time-mail-balloon-enhance-face ((t (:background "orange"))) t)
 '(display-time-mail-balloon-gnus-group-face ((t (:foreground "blue"))) t)
 ...
 '(gui-element ((t (:height 1.2 :background "#D4D0C8" :foreground "black"))) t)

 '(tinyreplace-:face ((t (:background "darkseagreen2" :foreground "blue"))) t)
 '(vc-mode-face  ((t (:background "darkseagreen2" :foreground "blue"))) t)

 '(highline ((t (:background "darkolivegreen"))) t)
 '(highline-face ((t (:background "darkolivegreen"))) t)
 ...
 '(jde-db-active-breakpoint-face ((t (:background "red" :foreground "black"))) t)
 '(jde-db-requested-breakpoint-face ((t (:background "yellow" :foreground "black"))) t)
 '(jde-db-spec-breakpoint-face ((t (:background "green" :foreground "black"))) t)
 ...
 '(highlight-changes-face ((t (:foreground "red"))) t)
 '(success ((t (:bold t :foreground "Green1" :weight bold))) t)
